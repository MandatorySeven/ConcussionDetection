...
public class BluetoothLeService extends Service {
    ...
    public static String String_ONBODYDETECTER_service =
            "00001234-0000-1000-8000-00805f9b34fb";
    public final static ParcelUuid ParcelUuid_ONBODYDETECTER_service =
            ParcelUuid.fromString(String_ONBODYDETECTER_service);
    public final static UUID UUID_ONBODYDETECTER_service =
            UUID.fromString(String_ONBODYDETECTER_service);
